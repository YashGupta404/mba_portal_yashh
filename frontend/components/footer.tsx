      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-gray-600 max-w-xl mx-auto">
            Excellence in Management Education for over 20 years. Shaping
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center md:text-left mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-700">
              <a href={`tel:${contactdata.phone}`} className="flex justify-center md:justify-start items-start gap-2">
                <Phone className="w-4 h-4 mt-0.5 text-gray-500" />
                <span>{contactdata.phone}</span>
              </a>
              <a href={`mailto:${contactdata.email}`} className="flex justify-center md:justify-start items-start gap-2">
