...
function ContactPage() {
    ...
    const handlesubmission = async (e)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5000/api/enquiry/post", formdata, {
                headers: {
    ...
    const getdata = async ()=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:5000/api/collegeinfo/getinfo", {
                headers: {
                    "Content-Type": "application/json"
                },
                withCredentials: true
            ...
            if (success) {
                setcontactData(data);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$contactStore$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setContactDataGlobal"])(data); // Update global state
            }
        } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bb11a165._.js.map