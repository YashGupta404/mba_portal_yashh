          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-slide-in-up">
              ...
              <p className="text-foreground/70 mb-6 leading-relaxed">
                ...
                their growth. This comprehensive program combines classroom learning, live projects, and international exposure.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 animate-slide-in-up">
              ...
              <div className="flex gap-4">
                ...
                <button
                  onClick={() => router.push("/programs/executive")}
                  className="px-8 py-3 border border-accent text-accent rounded-lg font-semibold hover:bg-accent hover:text-accent-foreground transition-all"
                >
                  Learn More
                </button>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-slide-in-up">
              ...
              <p className="text-foreground/70 mb-6 leading-relaxed">
                ...
                features live interactive classes, self-paced modules, and an industry-aligned curriculum.
              </p>
              ...
              <div className="flex gap-4">
                ...
                <button
                  onClick={() => router.push("/programs/online")}
                  className="px-8 py-3 border border-accent text-accent rounded-lg font-semibold hover:bg-accent hover:text-accent-foreground transition-all"
                >
                  Learn More
                </button>
